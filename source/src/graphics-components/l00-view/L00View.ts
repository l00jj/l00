...
class GuiController {
  ...
  constructor(worldController: WorldController, guiwraperEl: HTMLElement) {
    this.worldController = worldController
    //转移Dom
    this.fixGui(guiwraperEl)
  }

  /**
   * 修改debug位置
   */
  fixGui(guiwraperEl: HTMLElement) {
    const guiParentEl: HTMLElement = this.gui.domElement.parentElement!;
    guiwraperEl.appendChild(guiParentEl);
  }
...
class WorldController {
  ...
  addGui(guiwraperEl: HTMLElement) {
...
class View {
  ...
  removeEventListener() {
    ...
    this.worldController.guiController?.gui.destroy()
  }
}
