...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" style="display: none">
  ...
  <div class="container">
    <div class="fingerprint-group">
      ...
      <div class="fingerprint scanning">
        <svg xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 0 24 24" width="24px" fill="#3fefef">
          <use xlink:href="#fingerprint" />
        </svg>
      </div>
      <div class="fingerprint line scanning"></div>
    </div>
    <span>SCANNING</span>
  </div>
</template>
