...
import NavigationMenuA from "./l00-NavigationMenu-A.vue";
...
<template>
  <div class="container">
    <div class="container-item" :ref="(el) => componentList.push(el)" data-name="effect-phone-navigation-menu-a">
      <NavigationMenuA></NavigationMenuA>
    </div>
  </div>
</template>
