...
export default class Main extends EventEmitter {
    ...
    constructor(canvas: HTMLElement, viewArea: HTMLElement, viewControlsArea: HTMLElement) {
        super()

        // Options
        this.canvas = canvas;
        this.viewArea = viewArea;
        this.viewControlsArea = viewControlsArea ? viewControlsArea : this.canvas
