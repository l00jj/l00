...
export default class Geometrys {
    ...
    playAnimationTime = Infinity
    playAnimation() {
        if (Number.isNaN(this.playAnimationTime)) this.playAnimationTime = 0
        this.playAnimationTime += this.main.time.delta / 1000
        if (this.playAnimationTime > this.animationDelay) {
            this.playAnimationTime = this.playAnimationTime % this.animationDelay
            this.animation()
        }
    }
